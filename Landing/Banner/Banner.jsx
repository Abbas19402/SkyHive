...
const Banner = () => {
  return (
    <div className='w-full min-h-[90vh] md:h-[70vh]'>
      ...
      <div className="z-10 relative flex justify-start items-center md:p-20 lg:px-20 w-full h-full">
        <div className="w-full h-[60vh] md:h-[45vh] lg:w-[50vw] lg:min-h-[30vh] lg:max-h-[35vh] lg:-top-[10vh] lg:border-8 border-transparent">
          <Forms.SearchFlights/>
        </div>
      </div>
    </div>
